...
createCSSRule('.warning-could-not-enter-AR', "position: absolute; width: 181px; height: 50px; left: 50%; margin-left: -90px; z-index: 1; display: none;", false, '');
...
createCSSRule('.info-button', "position: absolute; height: 50px; width: 50px; z-index: 1; top: 10px; right: 10px; background-repeat: no-repeat; display: block; overflow: hidden; border-style: none; border-color: #000000; cursor: pointer;", false, '');
addHTMLElement('a', 'info_button', 'TO', ['CONTAINER'], false);
setHTMLElemAttribute('className', 'info-button', 'info_button', false);
setHTMLElemAttribute('href', 'https://meijir00.github.io/my3dprofile/', 'info_button', false);
setHTMLElemAttribute('target', '_blank', 'info_button', false);
addHTMLElement('img', 'info_button.img', 'TO', 'info_button', false);
setHTMLElemAttribute('src', 'media/info.png', 'info_button.img', false);
...
operateAnimation('PLAY', 'mel_armature', 0, 130, 'LoopRepeat', 1,
        function() {}, false);


volume(loadMedia_WebAudio('sounds/hello.mp3'), 1);
registerOnClick('mel_mesh', false, false, [0,1,2], function() {

  operateAnimation('STOP', 'mel_armature', null, null, 'AUTO', 1,
          function() {}, false);

      playSound(loadMedia_WebAudio('sounds/hello.mp3'), false);

  operateAnimation('PLAY', 'mel_armature', 131, 200, 'LoopOnce', 1,
          function() {
...
checkARMode(function() {
  eventHTMLElem('pointerup', 'enter_AR_button', false, function(event) {
    enterARMode('ORIGIN', true, function() {
      changeVis(['GROUP', 'MEL_GROUP'], false);
      ...
      changeVis(['GROUP', 'MEL_GROUP'], true);
      changeVis('prompt_move_around', false);
      setObjTransform('mel_armature', false, 'position', createVector(0, 0, 0), false);
      ...
      setObjTransform('mel_armature', false, 'scale', [1, 1, 1], false);
  ...
  setHTMLElemAttribute('href', exportToUSDZ('mel_mesh'), 'enter_AR_button', false);
  setHTMLElemAttribute('rel', 'ar', 'enter_AR_button', false);
  setHTMLElemAttribute('download', 'mel.usdz', 'enter_AR_button', false);
}, function() {
  eventHTMLElem('pointerup', 'enter_AR_button', false, function(event) {
...
registerOnClick('indicator_invis_plane', false, false, [0,1,2], function() {
  changeVis(['GROUP', 'MEL_GROUP'], true);
  changeVis(['GROUP', 'indicator_group'], false);
  setObjTransform('mel_armature', false, 'position', [arHitPoint('x'), arHitPoint('y'), arHitPoint('z')], false);
  setObjDirection('mel_armature', getObjTransform('Camera', false, 'position', 'xyz'), true, true);
...
registerOnDrag('drag_move', false, [0,1,2], function() {}, function() {
  dragMoveAdv('mel_armature', 'XY', 'WORLD', 'XUx|_m%U]I`X,qyZlIX/', 'eHN9LU8ZX`ayytMr~$5@');
}, function() {}, 'eHN9LU8ZX`ayytMr~$5@');

registerOnDrag('drag_rotate', false, [0,1,2], function() {}, function() {
  dragRotateAdv('mel_armature', 'Z', 'WORLD', 'CX3V,Ut-ffL)s$TT3gbj', 'up`@Al;^NMx{6Sq`%M}5');
}, function() {}, 'up`@Al;^NMx{6Sq`%M}5');

registerOnDrag('drag_scale', false, [0,1,2], function() {}, function() {
  dragScale('mel_armature', 'Z', 'W-QyU7R$3nrh2I70D2JY', 'M@,gtsCLK,d%!LAPl5O:');
  dragScale('mel_armature', 'Y', '/C|zWD.x)C*m234`$$?J', 'M@,gtsCLK,d%!LAPl5O:');
  dragScale('mel_armature', 'X', 'S^pBpxwpy5Ou]`[xDf*E', 'M@,gtsCLK,d%!LAPl5O:');
  updateTextObj('scale_percentage', String(Math.round(toFixedPoint(getObjTransform('mel_armature', false, 'scale', 'z'), 2) * 100)) + '%');
}, function() {}, 'M@,gtsCLK,d%!LAPl5O:');
